...
import 'package:flutter_application_1/pages/on_boarding.dart';
...
class _SplashScreanCanvas extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.quadraticBezierTo(size.width * 0.1, size.height * 0.24, size.width / 3.4,
        size.height * 0.12);

    path.quadraticBezierTo(size.width / 2.1, size.height * 0.05,
    ...
    path2.quadraticBezierTo(
        size.width * 0.70, size.height * 0.70, size.width, size.height);
